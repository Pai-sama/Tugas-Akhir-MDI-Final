...
new_villages_id = """
    ...
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'AWAL MULA',
          description: 'Menurut cerita lokal, masyarakat awalnya bekerja sebagai petani. Namun pada masa kolonial Belanda, warga beralih membuat gerabah dari tanah liat untuk bertahan hidup karena takut kehilangan ternak.',
        ),
        TimelineEvent(
          era: 'TAHUN 1970-AN',
          description: 'Perkembangan besar terjadi ketika seniman dan desainer mulai membantu memperkenalkan gerabah Kasongan ke pasar nasional dan internasional.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'WARISAN DUNIA',
          description: 'Bawomataluo pernah diajukan ke UNESCO sebagai kandidat warisan dunia karena arsitektur tradisional, tata desa kuno, dan budaya megalitiknya.',
        ),
      ],
    ),
    Village(
    ...
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'UNESCO GEOPARK',
          description: 'Kaldera Batur di Kintamani telah ditetapkan sebagai bagian dari UNESCO Global Geopark berkat keunikan geologi dan budaya lokal yang kaya.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          ...
          description: 'Desa Ponggok berhasil menjadi salah satu desa wisata terkaya dan paling inspiratif di Indonesia berkat inovasi pengelolaan wisata air melalui BUMDes.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          ...
          description: 'Kawasan ini merupakan bagian dari Karst Maros-Pangkep yang dikenal sebagai salah satu kawasan karst terbesar dan terindah di Asia Tenggara bahkan dunia.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'TAHUN 2008-2010',
          description: 'Masyarakat mulai secara swadaya membangun jaringan internet kampung dan sistem informasi warga, yang kemudian berkembang menjadi identitas unik Kampung Cyber.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'PERKAMPUNGAN KUNO',
          description: 'Desa Bena diperkirakan telah dihuni sejak ratusan tahun lalu dan hingga kini berhasil menjaga tata letak serta bentuk asli rumah tradisional peninggalan zaman megalitikum.',
        ),
      ],
    ),
"""
...
new_villages_en = """
    ...
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'THE BEGINNING',
          description: 'According to local stories, the people initially worked as farmers. During the Dutch colonial era, villagers shifted to making clay pottery for survival out of fear of losing their livestock.',
        ),
        TimelineEvent(
          era: '1970S',
          description: 'A major development occurred when artists and designers began helping to introduce Kasongan pottery to national and international markets.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'WORLD HERITAGE',
          description: 'Bawomataluo was once submitted to UNESCO as a candidate for a world heritage site due to its traditional architecture, ancient village layout, and megalithic culture.',
        ),
      ],
    ),
    Village(
    ...
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'UNESCO GEOPARK',
          description: 'The Batur Caldera in Kintamani has been designated as part of the UNESCO Global Geopark due to its unique geology and rich local culture.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          ...
          description: 'Ponggok Village successfully became one of the richest and most inspiring tourism villages in Indonesia thanks to innovative water tourism management through BUMDes.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          ...
          description: 'This area is part of the Maros-Pangkep Karst, known as one of the largest and most beautiful karst areas in Southeast Asia and the world.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'YEAR 2008-2010',
          description: 'The community independently began building a village internet network and citizen information system, which later developed into the unique identity of Kampung Cyber.',
        ),
      ],
    ),
    Village(
      ...
      historyTimeline: [
        TimelineEvent(
          era: 'ANCIENT SETTLEMENT',
          description: 'Bena Village is estimated to have been inhabited for hundreds of years and to this day successfully preserves the original layout and shape of traditional houses from the megalithic era.',
        ),
      ],
    ),
"""
...
def update_file(filepath, new_data):
    ...
    # We want to find the first occurence of `];` which ends the villages list.
    first_idx = content.find('];')
    if first_idx != -1:
        updated_content = content[:first_idx] + new_data + content[first_idx:]
...
update_file('d:/Hidden gem village/lib/data/app_data_id.dart', new_villages_id)
update_file('d:/Hidden gem village/lib/data/app_data_en.dart', new_villages_en)
